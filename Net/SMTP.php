...
class Net_SMTP
{
    ...
    {
        if ($this->isError($error = $this->_put($command))) {
            return $error;
        }
        if ($this->isError($error = $this->_parseResponse($valid))) {
            return $error;
        }
    ...
    function connect($timeout = null, $persistent = false)
    {
         ...
         */
        if ($this->_timeout > 0) {
            if ($this->isError($error = $this->setTimeout($this->_timeout))) {
                return $error;
            }
        }

        if ($this->isError($error = $this->_parseResponse(220))) {
            return $error;
        }
        ...
        if ($this->isError($error = $this->_negotiate())) {
            return $error;
        }
    ...
    function disconnect()
    {
        if ($this->isError($error = $this->_put('QUIT'))) {
            return $error;
        }
        if ($this->isError($error = $this->_parseResponse(221))) {
            return $error;
        }
        if ($this->isError($error = $this->_socket->disconnect())) {
    ...
    function _negotiate()
    {
        if ($this->isError($error = $this->_put('EHLO', $this->localhost))) {
            return $error;
        }

        if ($this->isError($this->_parseResponse(250))) {
            ...
            if ($this->isError($error = $this->_put('HELO', $this->localhost))) {
                return $error;
            }
            if ($this->isError($this->_parseResponse(250))) {
    ...
    function auth($uid, $pwd , $method = '', $tls = true, $authz = '')
    {
        ...
        if ($tls && version_compare(PHP_VERSION, '5.1.0', '>=') &&
            ...
            if ($this->isError($result = $this->_put('STARTTLS'))) {
                return $result;
            }
            if ($this->isError($result = $this->_parseResponse(220))) {
                return $result;
            }
            if ($this->isError($result = $this->_socket->enableCrypto(true, STREAM_CRYPTO_METHOD_TLS_CLIENT))) {
                return $result;
            } elseif ($result !== true) {
        ...
        if (empty($method)) {
            if ($this->isError($method = $this->_getBestAuthMethod())) {
    ...
    {
        if ($this->isError($error = $this->_put('AUTH', 'DIGEST-MD5'))) {
            return $error;
        }
        /* 334: Continue authentication request */
        if ($this->isError($error = $this->_parseResponse(334))) {
        ...
        if ($this->isError($error = $this->_put($auth_str))) {
            return $error;
        }
        /* 334: Continue authentication request */
        if ($this->isError($error = $this->_parseResponse(334))) {
         ...
         * it. */
        if ($this->isError($error = $this->_put(''))) {
            return $error;
        }
        /* 235: Authentication successful */
        if ($this->isError($error = $this->_parseResponse(235))) {
            return $error;
        }
    }
    ...
    {
        if ($this->isError($error = $this->_put('AUTH', 'CRAM-MD5'))) {
            return $error;
        }
        /* 334: Continue authentication request */
        if ($this->isError($error = $this->_parseResponse(334))) {
    ...
    {
        if ($this->isError($error = $this->_put('AUTH', 'LOGIN'))) {
            return $error;
        }
        /* 334: Continue authentication request */
        if ($this->isError($error = $this->_parseResponse(334))) {
        ...
        if ($this->isError($error = $this->_put(base64_encode($uid)))) {
            return $error;
        }
        /* 334: Continue authentication request */
        if ($this->isError($error = $this->_parseResponse(334))) {
        ...
        if ($this->isError($error = $this->_put(base64_encode($pwd)))) {
            return $error;
        }
    ...
    {
        if ($this->isError($error = $this->_put('AUTH', 'PLAIN'))) {
            return $error;
        }
        /* 334: Continue authentication request */
        if ($this->isError($error = $this->_parseResponse(334))) {
    ...
    {
        if ($this->isError($error = $this->_put('HELO', $domain))) {
            return $error;
        }
        if ($this->isError($error = $this->_parseResponse(250))) {
            return $error;
        }
    ...
    function mailFrom($sender, $params = null)
    {
        ...
        if ($this->isError($error = $this->_put('MAIL', $args))) {
            return $error;
        }
        if ($this->isError($error = $this->_parseResponse(250, $this->pipelining))) {
            return $error;
        }
    ...
    function rcptTo($recipient, $params = null)
    {
        ...
        if ($this->isError($error = $this->_put('RCPT', $args))) {
            return $error;
        }
        if ($this->isError($error = $this->_parseResponse(array(250, 251), $this->pipelining))) {
            return $error;
        }
    ...
    function data($data, $headers = null)
    {
        ...
        if ($this->isError($error = $this->_put('DATA'))) {
            return $error;
        }
        if ($this->isError($error = $this->_parseResponse(354))) {
            return $error;
        }
        ...
        if (!is_null($headers)) {
            ...
            if ($this->isError($result = $this->_send($headers . "\r\n\r\n"))) {
                return $result;
            }
        }
        ...
        if (is_resource($data)) {
            ...
            while (strlen($line = fread($data, 8192)) > 0) {
                ...
                $this->quotedata($line);
                if ($this->isError($result = $this->_send($line))) {
                    return $result;
                }
            }
        } else {
            ...
            for ($offset = 0; $offset < $size;) {
                ...
                if ($this->isError($result = $this->_send($chunk))) {
                    return $result;
                }
        ...
        if ($this->isError($result = $this->_send("\r\n.\r\n"))) {
            return $result;
        }
    ...
    {
        if ($this->isError($error = $this->_put('SEND', "FROM:<$path>"))) {
            return $error;
        }
        if ($this->isError($error = $this->_parseResponse(250, $this->pipelining))) {
            return $error;
    ...
    {
        if ($this->isError($error = $this->_put('SOML', "FROM:<$path>"))) {
            return $error;
        }
        if ($this->isError($error = $this->_parseResponse(250, $this->pipelining))) {
            return $error;
    ...
    {
        if ($this->isError($error = $this->_put('SAML', "FROM:<$path>"))) {
            return $error;
        }
        if ($this->isError($error = $this->_parseResponse(250, $this->pipelining))) {
            return $error;
    ...
    function rset()
    {
        if ($this->isError($error = $this->_put('RSET'))) {
            return $error;
        }
        if ($this->isError($error = $this->_parseResponse(250, $this->pipelining))) {
            return $error;
    ...
    function vrfy($string)
    {
        ...
        if ($this->isError($error = $this->_put('VRFY', $string))) {
            return $error;
        }
        if ($this->isError($error = $this->_parseResponse(array(250, 252)))) {
            return $error;
        }
    ...
    function noop()
    {
        if ($this->isError($error = $this->_put('NOOP'))) {
            return $error;
        }
        if ($this->isError($error = $this->_parseResponse(250))) {
            return $error;
